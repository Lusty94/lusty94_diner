...
RegisterServerEvent("lusty94_diner:server:bill:player")
AddEventHandler("lusty94_diner:server:bill:player", function(playerId, amount)
            ...
            if billed ~= nil then
                if biller.PlayerData.citizenid ~= billed.PlayerData.citizenid then
                    if amount and amount > 0 then
                        ...
                        --exports['qb-banking']:AddMoney( Config.CoreSettings.Job.Name,  amount,  'Diner Shop' ) -- uncomment this snippet if using the latest version of qb-core that removes the need for qb-management and uses qb-banking instead
